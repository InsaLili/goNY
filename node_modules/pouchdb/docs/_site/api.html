        ...
        <ul class='nav nav-header nav-pills'>
          ...
          <li>
            <a
                ...
                href="https://github.com/pouchdb/pouchdb/releases/download/3.3.1/pouchdb-3.3.1.min.js"
            >
                Download <strong>v3.3.1</strong>
            </a>
          </li>
        </ul>
...
<ul>
  ...
  <li><code>options.ajax</code>: (Remote databases only.) Ajax requester options. For instance, passing in the options <code>{ajax: {timeout: 10000}}</code> will allow you to set the max timeout for an HTTP request. These are passed ver batim to <a href="https://github.com/mikeal/request">request</a> (in Node.js) or  <a href="https://github.com/pouchdb/pouchdb/blob/master/lib/deps/request-browser.js">a request shim</a> (in the browser), with the exception of:
    <ul>
...
<ul>
  ...
  <li><code>options.descending</code>: Reverse the order of the output documents.</li>
  <li><code>options.since</code>: Start the results from the change immediately after the given sequence number. You can also pass ‘now’ if you want only new changes (when <code>live</code> is <code>true</code>).</li>
  ...
  <li><code>options.filter</code>: Reference a filter function from a design document to selectively get updates. To use a view function, pass <code>_view</code> here and provide a reference to the view function in <code>options.view</code>.</li>
...
<div class="highlight"><pre><code class="language-js" data-lang="js"><span class="nx">db</span><span class="p">.</span><span class="nx">getAttachment</span><span class="p">(</span><span class="s1">&#39;doc&#39;</span><span class="p">,</span> <span class="s1">&#39;att.txt&#39;</span><span class="p">,</span> <span class="kd">function</span><span class="p">(</span><span class="nx">err</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{</span>
  <span class="k">if</span> <span class="p">(</span><span class="nx">err</span><span class="p">)</span> <span class="p">{</span> <span class="k">return</span> <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">err</span><span class="p">);</span> <span class="p">}</span>
  <span class="c1">// handle result</span>
<span class="p">});</span></code></pre></div>
</div>
...
<div class="highlight"><pre><code class="language-js" data-lang="js"><span class="nx">db</span><span class="p">.</span><span class="nx">getAttachment</span><span class="p">(</span><span class="s1">&#39;doc&#39;</span><span class="p">,</span> <span class="s1">&#39;att.txt&#39;</span><span class="p">).</span><span class="nx">then</span><span class="p">(</span><span class="kd">function</span> <span class="p">(</span><span class="nx">result</span><span class="p">)</span> <span class="p">{</span>
  <span class="c1">// handle result</span>
<span class="p">}).</span><span class="k">catch</span><span class="p">(</span><span class="kd">function</span> <span class="p">(</span><span class="nx">err</span><span class="p">)</span> <span class="p">{</span>
  <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">err</span><span class="p">);</span>
<span class="p">});</span></code></pre></div>
...
<p>The response will be a <code>Blob</code> object in the browser, and a <code>Buffer</code> object in Node.js.</p>
...
<p>Since views perform a full scan of all documents, this method may be slow, unless you first save your view in a design document. Read the <a href="http://localhost:4000/guides/queries.html">query guide</a> for a good tutorial.</p>

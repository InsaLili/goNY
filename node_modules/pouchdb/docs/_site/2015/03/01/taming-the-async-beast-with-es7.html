    ...
    <header>
      ...
      <div class="page-head">
        ...
        <div class="container">
          ...
          <h1>Taming the asynchronous beast with ES7</h1>
...
<div class="post">
  <div class="media">
    ...
    <p>
      ...
      <strong>Published:</strong> 01 March 2015<br>
      ...
      <p>One of the trickiest aspects of PouchDB is that the API is asynchronous. I see no shortage of confused questions on Stack Overflow, Github, and IRC, and most often they stem from a misunderstanding of callbacks and promises.</p>
...
<p>When I try to think of elegant database APIs, however, I&#39;m still struck by the simplicity of LocalStorage:</p>
...
<p>For all of <a href="http://www.html5rocks.com/en/tutorials/offline/quota-research/">LocalStorage&#39;s</a> <a href="https://blog.mozilla.org/tglek/2012/02/22/psa-dom-local-storage-considered-harmful/">faults</a>, the ergonomics of this API help explain its continuing popularity. People keep using it, because it <em>just works</em>.</p>
...
<span class="k">for</span> <span class="p">(</span><span class="kd">let</span> <span class="nx">doc</span> <span class="nx">of</span> <span class="nx">docs</span><span class="p">)</span> <span class="p">{</span>
  <span class="kd">await</span> <span class="nx">db</span><span class="p">.</span><span class="nx">post</span><span class="p">(</span><span class="nx">doc</span><span class="p">);</span>
<span class="p">}</span></code></pre></div>
...
<p>ES7 is still very bleeding-edge. Async functions aren&#39;t supported in either Node.js or io.js, and you have to set some experimental flags to even get Babel to consider it.</p>
